...
2. Clone this repository (git clone https://github.com/DongjoonLim/graphylo.git). Download anaconda and follow commands below to create conda environment from yaml file. 
